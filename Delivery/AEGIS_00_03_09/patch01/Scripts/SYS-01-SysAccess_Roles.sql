...
--  05-SEP-2018, Rich Adase: Added general role PRIV_INTERFACE for shared table privileges
--**************************************************************************************
...
declare
  ...
  begin
    ...
    if (objCount > 0) then execute immediate 'drop role '||roleName; end if;
