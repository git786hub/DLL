...
values(g3e_customcommand_seq.nextval,'Streetlight Location History','Streetlight location history.','Tim Hooker',0,0,'Streetlight Location History',0,16,1,0,1,sysdate,'ccStreetLight:GTechnology.Oncor.CustomAPI.ccStreetLight');
