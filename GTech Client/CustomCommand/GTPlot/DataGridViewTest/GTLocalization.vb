...
Module GTLocalization
  ...
  Public Sub SetCurrentCulture(Optional ByVal sCultureInfo As String = "fr-CA")
    ...
    Try
      ...
      Thread.CurrentThread.CurrentCulture = New CultureInfo(sCultureInfo, True)
      Thread.CurrentThread.CurrentUICulture = New CultureInfo(sCultureInfo, True)
    ...
    Catch ex As Exception
      MsgBox("Localization.SetCurrentCulture:" & vbCrLf & ex.Message, vbOKOnly + vbExclamation, ex.Source)
  ...
  Public Function GetLanguage() As String
    ...
    Catch ex As Exception
      MsgBox("PlotBoundaryForm.GetLanguage:" & vbCrLf & ex.Message, vbOKOnly + vbExclamation, ex.Source)
      GetLanguage = Nothing
    End Try
