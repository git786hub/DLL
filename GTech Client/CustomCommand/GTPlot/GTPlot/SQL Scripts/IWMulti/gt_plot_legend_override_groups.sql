...
(
  ...
  LO_USERNAME             VARCHAR2(255 BYTE)        NULL,
  DRI_TYPE                VARCHAR2(255 BYTE)        NULL,
  MF_LNO                  NUMBER(5)                 NULL,
  LO_USER_OPTION          NUMBER                DEFAULT 0                         NULL,
  LO_USER_OPTION_DEFAULT  NUMBER                DEFAULT 0                         NULL
)
TABLESPACE GTECH
LOGGING 
NOCOMPRESS 
...
GRANT DELETE, INSERT, SELECT, UPDATE ON GT_PLOT_LEGEND_OVERRIDE_GROUPS TO ADMINISTRATOR;

GRANT SELECT ON GT_PLOT_LEGEND_OVERRIDE_GROUPS TO DESIGNER;

GRANT SELECT ON GT_PLOT_LEGEND_OVERRIDE_GROUPS TO FINANCE;

GRANT SELECT ON GT_PLOT_LEGEND_OVERRIDE_GROUPS TO MARKETING;

GRANT DELETE, INSERT, SELECT, UPDATE ON GT_PLOT_LEGEND_OVERRIDE_GROUPS TO SUPERVISOR;
