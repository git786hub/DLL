...
CREATE OR REPLACE TRIGGER M_T_BIUR_GTPLOTOBJCT_EDATE 
BEFORE INSERT OR UPDATE ON GT_PLOT_OBJECTS
FOR EACH ROW
BEGIN

  :NEW.OB_EDITDATE := SYSDATE;
END;
/
...
CREATE OR REPLACE PUBLIC SYNONYM GT_PLOT_OBJECTS FOR GT_PLOT_OBJECTS;
...
ALTER TABLE GT_PLOT_OBJECTS ADD (
  ...
  PRIMARY KEY
  (OB_NO)
  USING INDEX PK_GT_PLOT_OBJECTS_OB_NO
  ENABLE VALIDATE);
