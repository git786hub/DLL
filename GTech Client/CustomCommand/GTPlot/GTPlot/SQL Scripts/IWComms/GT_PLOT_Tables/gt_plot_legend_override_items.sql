...
(
  LO_ITEM_NO                NUMBER,
  LO_GROUP_ID               NUMBER,
  LO_LEGENDITEM             VARCHAR2(80 BYTE),
  LO_DISPLAYMODE            NUMBER(1)           DEFAULT 1,
  LO_FILTER                 VARCHAR2(240 BYTE),
  LO_DISPLAYMODE_UNCHECKED  NUMBER(1)           DEFAULT 1,
  LO_FILTER_UNCHECKED       VARCHAR2(240 BYTE),
...
CREATE OR REPLACE TRIGGER M_T_BIUR_GTPLOTLGOVI_EDATE 
BEFORE INSERT OR UPDATE ON GT_PLOT_LEGEND_OVERRIDE_ITEMS
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE PUBLIC SYNONYM GT_PLOT_LEGEND_OVERRIDE_ITEMS FOR GT_PLOT_LEGEND_OVERRIDE_ITEMS;
...
ALTER TABLE GT_PLOT_LEGEND_OVERRIDE_ITEMS ADD (
  ...
  PRIMARY KEY
  (LO_ITEM_NO)
  USING INDEX PK_GT_PLOT_LEG_OVR_ITMS_ITM_NO
  ENABLE VALIDATE);
...
GRANT DELETE, INSERT, SELECT, UPDATE ON GT_PLOT_LEGEND_OVERRIDE_ITEMS TO PUBLIC;
