  ...
  Public Class NewPlotWindow
    ...
    Public Sub Activate(ByVal CustomCommandHelper As IGTCustomCommandHelper) Implements IGTCustomCommandModeless.Activate
      Try
        ...
        If IsNothing(m_NewPlotWindowForm) Then
          m_NewPlotWindowForm = New NewPlotWindowForm
          m_NewPlotWindowForm.Show(objWinWrapper)
        Else
          m_NewPlotWindowForm.Show()
        End If
    ...
    Private Sub m_NewPlotWindowForm_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles m_NewPlotWindowForm.Disposed
      Try
        m_oCustomCommandHelper.Complete()
      Catch ex As Exception
