...
//  Description: ValidationRuleManager is common class to to display the proper messages to the user.
//----------------------------------------------------------------------------+
//     $$Author::         HCCI                                                $
//       $$Date::         07/02/2017 3.30 PM                                  $
//   $$Revision::         1                                                   $
//----------------------------------------------------------------------------+
//    $$History::         ValidationRuleManager.cs                                   $
//
//************************Version 1**************************
//User: Sithara    Date: 07/02/2017   Time : 3.30PM
//Created ValidationRuleManager.cs class
//----------------------------------------------------------------------------+
using System;
...
namespace GTechnology.Oncor.CustomAPI
{
    public class ValidationRuleManager
    {
        ...
        /// Get Message.
        /// </summary>
        /// <param name="Args">Args to replace the message.</param>
