...
@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_CATEGORY.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_MACRO.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_MACROUNIT.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_MATERIAL.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_UNIT.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_UNITATTRIBUTE.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_UNITMATERIAL.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_MACROCATEGORY.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Tables/CULIB_UNITCATEGORY.sql"
...
@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Tables/STG_CULIB_MULTIPLE_CATEGORY.sql"
...
@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Triggers/BIU_CULIB_MACROCATEGORY_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Triggers/BIU_CULIB_UNITCATEGORY_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_STG_CULIB_CATEGORY_TBL_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_CATEGORY_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_MACRO_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_MACROUNIT_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_MATERIAL_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_UNIT_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_UNITATTRIBUTE_TR.sql"

@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_CULIB_UNITMATERIAL_TR.sql"
...
@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-STG-CULIB-DDL/Triggers/BIU_STG_CULIB_MULTIPLE_CATEGORY_TR.sql"
...
@"/data/app/oracle/admin/Releases/RELEASE_ID/GIS-ONC-CULIB-DDL/Packages/GISPKG_WMIS_CULIBRARY.sql"
...
@"/data/app/oracle/admin/Releases/RELEASE_ID/Master-Script/AEGIS_GIS_INFA_ACL.sql" odcdiswdapp07.build.corp.oncor.com

@"/data/app/oracle/admin/Releases/RELEASE_ID/Master-Script/AEGIS_SYS_GENERALPARAMETER_EdgeFrontier_Hosts.sql" odcdiswdapp07.build.corp.oncor.com
